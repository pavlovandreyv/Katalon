...
WebUI.callTestCase(findTestCase('BASE/Open/Open schedule plan'), [:], FailureHandling.STOP_ON_FAILURE)
...
'Ожидание активации узла утверждения'
WebUI.waitForElementPresent(findTestObject('ROUTE/name_activity'), 180)

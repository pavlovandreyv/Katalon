...
WebUiBuiltInKeywords.setText(findTestObject('page_authorization/input_login'), GlobalVariable.LoginAdmin)

'Ввести пароль администратора'
WebUiBuiltInKeywords.setText(findTestObject('page_authorization/input_password'), GlobalVariable.PasswordAdmin)
